...
<tr><td><b>Id</b></td><td><code>azure.logic_apps.workflow_run_action_repetitions_request_histories</code></td></tr>
</tbody></table>
...
| `WorkflowRunActionRepetitionsRequestHistories_Get` | `EXEC` | `actionName, api-version, repetitionName, requestHistoryName, resourceGroupName, runName, subscriptionId, workflowName` | Gets a workflow run repetition request history. |
