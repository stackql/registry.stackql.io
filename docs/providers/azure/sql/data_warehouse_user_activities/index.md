...
| `DataWarehouseUserActivities_Get` | `EXEC` | `dataWarehouseUserActivityName, databaseName, resourceGroupName, serverName, subscriptionId` | Gets the user activities of a data warehouse which includes running and suspended queries |
