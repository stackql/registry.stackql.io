...
<tr><td><b>Id</b></td><td><code>azure.cognitive_services.private_endpoint_connections</code></td></tr>
</tbody></table>
...
| `PrivateEndpointConnections_Get` | `EXEC` | `accountName, privateEndpointConnectionName, resourceGroupName, subscriptionId` | Gets the specified private endpoint connection associated with the Cognitive Services account. |
