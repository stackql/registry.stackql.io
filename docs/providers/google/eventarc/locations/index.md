...
<tr><td><b>Id</b></td><td><code>google.eventarc.locations</code></td></tr>
</tbody></table>
...
| `projects_locations_updateGoogleChannelConfig` | `EXEC` | `name` | Update a single GoogleChannelConfig |
