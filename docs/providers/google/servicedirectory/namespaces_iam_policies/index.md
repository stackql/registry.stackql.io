...
|:-----|:--------------|:----------------|:------------|
| `projects_locations_namespaces_getIamPolicy` | `SELECT` | `resource` | Gets the IAM Policy for a resource (namespace or service only). |
| `projects_locations_namespaces_setIamPolicy` | `EXEC` | `resource` | Sets the IAM Policy for a resource (namespace or service only). |
| `projects_locations_namespaces_testIamPermissions` | `EXEC` | `resource` | Tests IAM permissions for a resource (namespace or service only). |
