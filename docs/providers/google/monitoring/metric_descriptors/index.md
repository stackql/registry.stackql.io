...
|:-----|:--------------|:----------------|:------------|
| `projects_metricDescriptors_get` | `SELECT` | `name` | Gets a single metric descriptor. |
| `projects_metricDescriptors_list` | `SELECT` | `name` | Lists metric descriptors that match a filter. |
| `projects_metricDescriptors_create` | `INSERT` | `name` | Creates a new metric descriptor. The creation is executed asynchronously and callers may check the returned operation to track its progress. User-created metric descriptors define custom metrics (https://cloud.google.com/monitoring/custom-metrics). |
| `projects_metricDescriptors_delete` | `DELETE` | `name` | Deletes a metric descriptor. Only user-created custom metrics (https://cloud.google.com/monitoring/custom-metrics) can be deleted. |
