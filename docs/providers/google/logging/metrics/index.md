...
|:-----|:--------------|:----------------|:------------|
| `projects_metrics_get` | `SELECT` | `metricName` | Gets a logs-based metric. |
| `projects_metrics_list` | `SELECT` | `parent` | Lists logs-based metrics. |
| `projects_metrics_create` | `INSERT` | `parent` | Creates a logs-based metric. |
| `projects_metrics_delete` | `DELETE` | `metricName` | Deletes a logs-based metric. |
| `projects_metrics_update` | `EXEC` | `metricName` | Creates or updates a logs-based metric. |
