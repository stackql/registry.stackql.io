...
| `billingAccounts_locations_buckets_undelete` | `EXEC` | `billingAccountsId, bucketsId:undelete, locationsId` | Undeletes a log bucket. A bucket that has been deleted can be undeleted within the grace period of 7 days. |
...
| `folders_locations_buckets_undelete` | `EXEC` | `bucketsId:undelete, foldersId, locationsId` | Undeletes a log bucket. A bucket that has been deleted can be undeleted within the grace period of 7 days. |
...
| `organizations_locations_buckets_undelete` | `EXEC` | `bucketsId:undelete, locationsId, organizationsId` | Undeletes a log bucket. A bucket that has been deleted can be undeleted within the grace period of 7 days. |
...
| `projects_locations_buckets_undelete` | `EXEC` | `bucketsId:undelete, locationsId, projectsId` | Undeletes a log bucket. A bucket that has been deleted can be undeleted within the grace period of 7 days. |
