...
| `aggregatedList` | `EXEC` | `project` | Retrieves an aggregated list of routers. |
| `getNatMappingInfo` | `EXEC` | `project, region, router` | Retrieves runtime Nat mapping information of VM endpoints. |
| `getRouterStatus` | `EXEC` | `project, region, router` | Retrieves runtime information of the specified router. |
