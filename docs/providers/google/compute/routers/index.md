...
|:-----|:--------------|:----------------|:------------|
| `routers_aggregatedList` | `SELECT` | `project` | Retrieves an aggregated list of routers. |
| `routers_get` | `SELECT` | `project, region, router` | Returns the specified Router resource. Gets a list of available routers by making a list() request. |
| `routers_list` | `SELECT` | `project, region` | Retrieves a list of Router resources available to the specified project. |
| `routers_insert` | `INSERT` | `project, region` | Creates a Router resource in the specified project and region using the data included in the request. |
| `routers_delete` | `DELETE` | `project, region, router` | Deletes the specified Router resource. |
