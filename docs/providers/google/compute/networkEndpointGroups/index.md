...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>networkEndpointGroups</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><code>google.compute.networkEndpointGroups</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|:------------|
| `get` | `SELECT` | `networkEndpointGroup, project, zone` | Returns the specified network endpoint group. Gets a list of available network endpoint groups by making a list() request. |
| `list` | `SELECT` | `project, zone` | Retrieves the list of network endpoint groups that are located in the specified project and zone. |
