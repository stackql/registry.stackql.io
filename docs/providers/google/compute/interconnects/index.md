...
|:-----|:--------------|:----------------|:------------|
| `interconnects_get` | `SELECT` | `interconnect, project` | Returns the specified interconnect. Get a list of available interconnects by making a list() request. |
| `interconnects_list` | `SELECT` | `project` | Retrieves the list of interconnect available to the specified project. |
| `interconnects_insert` | `INSERT` | `project` | Creates a Interconnect in the specified project using the data included in the request. |
| `interconnects_delete` | `DELETE` | `interconnect, project` | Deletes the specified interconnect. |
| `interconnects_patch` | `EXEC` | `interconnect, project` | Updates the specified interconnect with the data included in the request. This method supports PATCH semantics and uses the JSON merge patch format and processing rules. |
