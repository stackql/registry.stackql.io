...
|:-----|:--------------|:----------------|:------------|
| `addresses_aggregatedList` | `SELECT` | `project` | Retrieves an aggregated list of addresses. |
| `addresses_get` | `SELECT` | `address, project, region` | Returns the specified address resource. |
| `addresses_list` | `SELECT` | `project, region` | Retrieves a list of addresses contained within the specified region. |
| `addresses_insert` | `INSERT` | `project, region` | Creates an address resource in the specified project by using the data included in the request. |
| `addresses_delete` | `DELETE` | `address, project, region` | Deletes the specified address resource. |
