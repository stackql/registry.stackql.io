...
| `insert` | `INSERT` | `project, region, data__name` | Creates an address resource in the specified project by using the data included in the request. |
| `delete` | `DELETE` | `address, project, region` | Deletes the specified address resource. |
| `aggregatedList` | `EXEC` | `project` | Retrieves an aggregated list of addresses. |
