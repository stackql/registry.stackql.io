...
|:-----|:--------------|:----------------|:------------|
| `feeds_get` | `SELECT` | `name` | Gets details about an asset feed. |
| `feeds_list` | `SELECT` | `parent` | Lists all asset feeds in a parent project/folder/organization. |
| `feeds_create` | `INSERT` | `parent` | Creates a feed in a parent project/folder/organization to listen to its asset updates. |
| `feeds_delete` | `DELETE` | `name` | Deletes an asset feed. |
| `feeds_patch` | `EXEC` | `name` | Updates an asset feed configuration. |
