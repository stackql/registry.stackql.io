...
| `projects_locations_keys_undelete` | `EXEC` | `keysId:undelete, locationsId, projectsId` | Undeletes an API key which was deleted within 30 days. NOTE: Key is a global resource; hence the only supported value for location is `global`. |
