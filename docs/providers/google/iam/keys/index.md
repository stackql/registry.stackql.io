...
| `projects_serviceAccounts_keys_disable` | `EXEC` | `keysId:disable, projectsId, serviceAccountsId` | Disable a ServiceAccountKey. A disabled service account key can be re-enabled with EnableServiceAccountKey. |
| `projects_serviceAccounts_keys_enable` | `EXEC` | `keysId:enable, projectsId, serviceAccountsId` | Enable a ServiceAccountKey. |
