...
|:-----|:--------------|:----------------|:------------|
| `projects_locations_dataExchanges_getIamPolicy` | `SELECT` | `resource` | Gets the IAM policy. |
| `projects_locations_dataExchanges_setIamPolicy` | `EXEC` | `resource` | Sets the IAM policy. |
| `projects_locations_dataExchanges_testIamPermissions` | `EXEC` | `resource` | Returns the permissions that a caller has. |
