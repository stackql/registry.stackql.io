...
|:-----|:--------------|:----------------|:------------|
| `projects_locations_dataExchanges_listings_getIamPolicy` | `SELECT` | `resource` | Gets the IAM policy. |
| `projects_locations_dataExchanges_listings_setIamPolicy` | `EXEC` | `resource` | Sets the IAM policy. |
| `projects_locations_dataExchanges_listings_testIamPermissions` | `EXEC` | `resource` | Returns the permissions that a caller has. |
