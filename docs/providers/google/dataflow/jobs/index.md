...
| `projects_jobs_snapshot` | `EXEC` | `jobId:snapshot, projectId` | Snapshot the state of a streaming job. |
...
| `projects_locations_jobs_snapshot` | `EXEC` | `jobId:snapshot, location, projectId` | Snapshot the state of a streaming job. |
