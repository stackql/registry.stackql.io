...
| `projects_locations_sources_migratingVms_cloneJobs_cancel` | `EXEC` | `cloneJobsId:cancel, locationsId, migratingVmsId, projectsId, sourcesId` | Initiates the cancellation of a running clone job. |
