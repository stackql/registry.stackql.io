...
| `projects_tenants_jobs_create` | `INSERT` | `projectsId, tenantsId` | Creates a new job. Typically, the job becomes searchable within 10 seconds, but it may take up to 5 minutes. |
