...
|:-----|:--------------|:----------------|:------------|
| `projects_locations_repositories_dockerImages_get` | `SELECT` | `name` | Gets a docker image. |
| `projects_locations_repositories_dockerImages_list` | `SELECT` | `parent` | Lists docker images. |
