...
|:-----|:--------------|:----------------|:------------|
| `projects_locations_taxonomies_getIamPolicy` | `SELECT` | `resource` | Gets the IAM policy for a policy tag or a taxonomy. |
| `projects_locations_taxonomies_setIamPolicy` | `EXEC` | `resource` | Sets the IAM policy for a policy tag or a taxonomy. |
| `projects_locations_taxonomies_testIamPermissions` | `EXEC` | `resource` | Returns your permissions on a specified policy tag or taxonomy. |
