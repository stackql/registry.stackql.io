...
| `projects_locations_deliveryPipelines_releases_abandon` | `EXEC` | `deliveryPipelinesId, locationsId, projectsId, releasesId:abandon` | Abandons a Release in the Delivery Pipeline. |
