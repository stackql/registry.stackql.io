...
|:-----|:--------------|:----------------|:------------|
| `folders_bigQueryExports_get` | `SELECT` | `name` | Gets a big query export. |
| `folders_bigQueryExports_list` | `SELECT` | `parent` | Lists BigQuery exports. Note that when requesting BigQuery exports at a given level all exports under that level are also returned e.g. if requesting BigQuery exports under a folder, then all BigQuery exports immediately under the folder plus the ones created under the projects within the folder are returned. |
| `organizations_bigQueryExports_get` | `SELECT` | `name` | Gets a big query export. |
| `organizations_bigQueryExports_list` | `SELECT` | `parent` | Lists BigQuery exports. Note that when requesting BigQuery exports at a given level all exports under that level are also returned e.g. if requesting BigQuery exports under a folder, then all BigQuery exports immediately under the folder plus the ones created under the projects within the folder are returned. |
| `projects_bigQueryExports_get` | `SELECT` | `name` | Gets a big query export. |
| `projects_bigQueryExports_list` | `SELECT` | `parent` | Lists BigQuery exports. Note that when requesting BigQuery exports at a given level all exports under that level are also returned e.g. if requesting BigQuery exports under a folder, then all BigQuery exports immediately under the folder plus the ones created under the projects within the folder are returned. |
| `folders_bigQueryExports_create` | `INSERT` | `parent` | Creates a big query export. |
| `organizations_bigQueryExports_create` | `INSERT` | `parent` | Creates a big query export. |
| `projects_bigQueryExports_create` | `INSERT` | `parent` | Creates a big query export. |
| `folders_bigQueryExports_delete` | `DELETE` | `name` | Deletes an existing big query export. |
| `organizations_bigQueryExports_delete` | `DELETE` | `name` | Deletes an existing big query export. |
| `projects_bigQueryExports_delete` | `DELETE` | `name` | Deletes an existing big query export. |
| `folders_bigQueryExports_patch` | `EXEC` | `name` | Updates a BigQuery export. |
| `organizations_bigQueryExports_patch` | `EXEC` | `name` | Updates a BigQuery export. |
| `projects_bigQueryExports_patch` | `EXEC` | `name` | Updates a BigQuery export. |
