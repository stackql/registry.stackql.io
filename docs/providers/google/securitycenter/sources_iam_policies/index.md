...
|:-----|:--------------|:----------------|:------------|
| `organizations_sources_getIamPolicy` | `SELECT` | `resource` | Gets the access control policy on the specified Source. |
| `organizations_sources_setIamPolicy` | `EXEC` | `resource` | Sets the access control policy on the specified Source. |
| `organizations_sources_testIamPermissions` | `EXEC` | `resource` | Returns the permissions that a caller has on the specified source. |
