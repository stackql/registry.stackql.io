...
|:-----|:--------------|:----------------|:------------|
| `folders_sources_list` | `SELECT` | `parent` | Lists all sources belonging to an organization. |
| `organizations_sources_get` | `SELECT` | `name` | Gets a source. |
| `organizations_sources_list` | `SELECT` | `parent` | Lists all sources belonging to an organization. |
| `projects_sources_list` | `SELECT` | `parent` | Lists all sources belonging to an organization. |
| `organizations_sources_create` | `INSERT` | `parent` | Creates a source. |
| `organizations_sources_patch` | `EXEC` | `name` | Updates a source. |
